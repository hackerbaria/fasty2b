...
public class PlayListInfoDTO implements Serializable{
	...
	public PlayListInfoDTO(String id, String title, String privacy, String description, DateTime postedTime,
			String chanel) {
		super();
		this.id = id;
		this.title = title;
